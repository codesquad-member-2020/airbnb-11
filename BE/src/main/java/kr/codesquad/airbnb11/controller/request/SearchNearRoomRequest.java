...
public class SearchNearRoomRequest {
  ...
  public SearchNearRoomRequest() {
    page = 1;
  }

  public SearchNearRoomRequest(String checkIn, String checkOut, Integer priceMin,
      Integer priceMax, Integer adult, Integer children, Integer infants, int page,
