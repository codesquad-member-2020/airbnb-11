...
VALUES (8,
        ...
        ST_GeomFromText('POINT(46.8182 8.2275)'), 3.12, 13, 1);
...
VALUES (11, 'https://a1.muscache.com/im/pictures/89438360/ad8d6e7b_original.jpg?aki_policy=large',
        ...
        ST_GeomFromText('POINT(55.3781 3.4360)'), 3.09, 18, 1);
...
VALUES (4,
        ...
        ST_GeomFromText('POINT(51.1657 10.4515)'), 4.53, 189, 3);
...
VALUES (10, 'https://a2.muscache.com/im/pictures/100311920/8a1547f9_original.jpg?aki_policy=large',
        ...
        ST_GeomFromText('POINT(50.1109 8.6821)'), 4.91, 323, 1);
