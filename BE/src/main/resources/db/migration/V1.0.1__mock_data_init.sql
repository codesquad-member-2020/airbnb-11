...
INSERT INTO room (max_person_count, main_image, title, daily_price, country, location, rating,
...
VALUES (2,
        ...
        'Mark P.Coleman', 506, '스페인', st_GeomFromText('POINT(40.4637 3.7492)'), 3.63, 111, 1);
INSERT INTO room (max_person_count, main_image, title, daily_price, country, location, rating,
                  review_count, user_id)
VALUES (5,
...
VALUES (7,
        ...
        'Private Apartment!', 296, '프랑스', st_GeomFromText('POINT(46.2276 2.2137)'), 2.93, 33, 1);
INSERT INTO room (max_person_count, main_image, title, daily_price, country, location, rating,
                  review_count, user_id)
VALUES (8,
...
VALUES (14, 'https://a2.muscache.com/im/pictures/24731791/1bf3bc7c_original.jpg?aki_policy=large',
        'Awesome Room', 235, '프랑스', st_GeomFromText('POINT(45.7640 4.8357)'), 3.77, 51, 1);
INSERT INTO room (max_person_count, main_image, title, daily_price, country, location, rating,
                  review_count, user_id)
